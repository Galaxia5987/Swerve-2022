...
public class TurnToAngle extends CommandBase {
    ...
    @Override
    public void execute() {
        swerveDrive.holonomicDriveKeepSetpoint(0, 0, targetAngle.get());
    }

    @Override
    public boolean isFinished() {
        return Robot.getAngle().minus(targetAngle.get()).getRadians() < Constants.SwerveDrive.ALLOWABLE_THETA_ERROR;
    }
