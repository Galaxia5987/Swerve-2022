...
public class RobotRotationTest extends CommandBase {
    ...
    public RobotRotationTest(SwerveDrive swerveDrive, DoubleSupplier forwardSupplier, DoubleSupplier strafeSupplier, DoubleSupplier rotationSupplier) {
    ...
    public void execute() {
        ...
        System.out.println(Robot.getAngle().getDegrees());
    }
